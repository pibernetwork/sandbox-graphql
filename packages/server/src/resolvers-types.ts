...
import { ProfileWithId, UserWithId } from 'library/src/index.js';
...
export type ResolversTypes = ResolversObject<{
  ...
  ProfileConnection: ResolverTypeWrapper<
    Omit<ProfileConnection, 'nodes'> & {
      nodes: Array<ResolversTypes['Profile']>;
    }
  >;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  ProfileConnection: Omit<ProfileConnection, 'nodes'> & {
    nodes: Array<ResolversParentTypes['Profile']>;
  };
  ProfileConnectionFilter: ProfileConnectionFilter;
  ProfileWeightFilter: ProfileWeightFilter;
  Query: {};
...
> = ResolversObject<{
  addProfile?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddProfileArgs, 'birthday' | 'userId' | 'weight'>
  >;
  delProfile?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<MutationDelProfileArgs, '_id'>
  >;
...
export type ProfileConnectionResolvers<
  ContextType = GraphQLContext,
  ParentType extends
    ResolversParentTypes['ProfileConnection'] = ResolversParentTypes['ProfileConnection']
> = ResolversObject<{
...
> = ResolversObject<{
  ...
  profile?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryProfileArgs, '_id'>
  >;
  profiles?: Resolver<
    Array<Maybe<ResolversTypes['Profile']>>,
    ParentType,
    ContextType
  >;
  profilesConnection?: Resolver<
    ResolversTypes['ProfileConnection'],
    ParentType,
    ContextType,
    RequireFields<
      QueryProfilesConnectionArgs,
  ...
  user?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryUserArgs, '_id'>
  >;
  users?: Resolver<
...
export type SelectOptionResolvers<
  ContextType = GraphQLContext,
  ParentType extends
    ResolversParentTypes['SelectOption'] = ResolversParentTypes['SelectOption']
> = ResolversObject<{
